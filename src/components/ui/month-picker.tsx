 ...
 * @return {ReactElement} the MonthPicker component
 */
const MonthPicker = ({ dateRange, validYears, onChange }): ReactElement => {
  ...
  const [endMonth, setEndMonth] = useState(monthNames[dateRange.to.getMonth()]);
  const [endYear, setEndYear] = useState(dateRange.to.getFullYear().toString());
