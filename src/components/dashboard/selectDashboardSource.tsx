 ...
 * @return {ReactElement} The rendered SelectDashboardSource component.
 */
export const SelectDashboardSource = ({
  ...
  const [date, setDate] = useState<Date | undefined>(new Date(currentFileDate));
        ...
        >
          ...
          >
            ...
            <Button
              variant={"outline"}
              onClick={() =>
                downloadWrapper(globalSummaryData as Object, "AURORA_dataset")
              }
