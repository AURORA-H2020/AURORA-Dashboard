 ...
 * @return {ReactNode} The rendered consumption timeline chart.
 */
const ConsumptionTimelineChart = ({
  ...
  }, [globalSummaryData, selectedEnergyMode, categories, dateRange, t, locale]);
    ...
    <>
      ...
      {dateRange?.from && dateRange?.to && dateRange.from < dateRange.to ? (
        <LineChart
          ...
          index="dateString"
          categories={getSortedCountryLabels(includedCountryIds).names.map(
            (name) => t(name),
          )}
